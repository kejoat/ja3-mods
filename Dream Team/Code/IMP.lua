...
--Max stats points to spread
--DefineConst({
--  Comment = "Max stats points to spread.",
--  group = "Imp",
--  id = "MaxStatPoints",
--  value = 1000 --Default: 550
--})
...
--Make [Reckless Rush] invincible!(Remove Tiredness)
...
--  "Teacher",
  ...
  --[Hard-coded binding of character perks]
  --Wait for test confirmation
  --"RecklessAssault"--Result: No errors ->Report:"The Perk Restless Rush doesn't work. It says wrong weapon even though it is a SMG."
  ...
  "DesignerExplosives",
  "WeaponPersonalization",
  "InnerInfo",--Result: untested  ->Report:"Livewire's perk "Inside Dope" doesn't work.""
  "HaveABlast",--Result: After activating the ability, being attacked will not fight back
  "GruntyPerk",--Result:
  ]]


  -- > Please pay attention to the "," symbol format, the last item is not required.
}
--=============================================================
