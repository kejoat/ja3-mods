PlaceObj("XTemplate", {
  ...
  PlaceObj("XTemplateWindow", {
    ...
    PlaceObj("XTemplateFunc", {
      ...
      "func",
      function(self, ...)
        return ImpGetUnassignedStatPoints() >= 0 --属性点分配检测
      end
    }),
    PlaceObj("XTemplateFunc", {
      "name",
    ...
    PlaceObj("XTemplateFunc", {
      ...
      "func",
      function(self, ...)
        return g_ImpTest.final and g_ImpTest.final.perks and g_ImpTest.final.perks.tactical and #g_ImpTest.final.perks.tactical >= 2 and #g_ImpTest.final.perks.tactical <= g_MaxPerksCount --技能上限
      end
    }),
    PlaceObj("XTemplateWindow", {
      "__class",
              ...
              PlaceObj("XTemplateMode", {
                ...
                PlaceObj("XTemplateAction", {
                  ...
                  function(self, host)
                    ...
                    return host.impconfirm.confirm and CanPay(const.Imp.CertificateCost) and "enabled" or "disabled"--打钱按钮启用
                  end,
                  "OnAction",
                  function(self, host, source, ...)
