        ...
        local exec = function(self, mercId, price, days, alreadyHired)
          ...
          if unit and HasPerk(unit, self.id) and 0 < days then
            ...
            if canPlaceError then
              CombatLog("important", T(667077082306, "The merc has baked some biscuits. Unfortunately the inventory is full. "))
              return
            end
            CombatLog("important", T(754424382903, "The merc has baked some biscuits"))
...
The merc also makes <GameTerm('Biscuits')>.]]),
