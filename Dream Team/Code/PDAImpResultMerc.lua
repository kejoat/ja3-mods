          ...
          PlaceObj("XTemplateWindow", {
            ...
            PlaceObj("XTemplateWindow", {
              ...
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(960500439279, "Personal perks 1/1")--个人技能
              }),
              PlaceObj("XTemplateWindow", {
                "Margins",
                box(16, 8, 16, 0),--页边距
                ...
                PlaceObj("XTemplateForEach", {
                  ...
                  "array",
                  function(parent, context)
                    return ImpGetPersonalPerks()--个人技能
                  end,
                  "__context",
              ...
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(7474381573311, "Tactical perks 5/5")--战术技能
              }),
              PlaceObj("XTemplateWindow", {
                "Margins",
                box(16, 8, 16, 0),--图标间距
                      ...
                      function(self, pos, button)
                        if button == "L" then
                          ...
                          if perkIndex then
                            ...
                            -- 如果已选择了最大数量的技能，则移除第一个选择再添加新选择
                            if #tactical >= g_MaxPerksCount then
