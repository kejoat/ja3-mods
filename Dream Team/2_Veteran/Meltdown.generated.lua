  ...
  HaggleRehire = {
    PlaceObj("MercChatHaggle", {
      "Lines",
      {
        PlaceObj("ChatMessage", {
          "Text",
          T(569509023059, "Hey! I thought I was gonna see some action. Most danger I've seen so far was the tacos I had for lunch. Thought I'd never get off the toilet. I got better things to do than hang around and look pretty for ya. Kick in some extra money or I'll start these boots a-walkin.")
        })
      },
      "Conditions",
      {
